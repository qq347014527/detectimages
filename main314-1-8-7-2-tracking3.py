...
list_pts_blue = [[970, 490], [965, 737], [1329, 765], [1337, 503]]
...
list_pts_yellow = [[733, 797], [677, 883], [1753, 979], [1753, 885]]
ndarray_pts_yellow = np.array(list_pts_yellow, np.int32)
polygon_yellow_value_2 = cv2.fillPoly(mask_image_temp, [ndarray_pts_yellow], color=30)
...
# 蓝 色盘 b,g,r
blue_color_plate = [3, 0, 0]
# 蓝 polygon图片
blue_image = np.array(polygon_blue_value_1 * blue_color_plate, np.uint8)

# 黄 色盘
yellow_color_plate = [0, 2, 2]
# 黄 polygon图片
        ...
        if q.empty() !=True:
            ...
            if len(list_bboxs) > 0:
                ...
                for item_bbox in list_bboxs:
                    ...
                    elif polygon_mask_blue_and_yellow[y, x] == 30:
                        # 如果撞 黄polygon
